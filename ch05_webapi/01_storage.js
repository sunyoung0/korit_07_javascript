...
if (Storage !== undefined) {
  ...
  console.log(localStorage.getItem('users'));   // 결과값 : [{"id":1,"name":"김일"},{"id":2,"name":"김이"}]
  // 이 경우 26 /27 라인의 결과값 자료형은 전부 string에 해당함.
  // 그래서 그냥 27번 라인을 string으로 쓸거라면 별 문제가 없겠지만 굳이 객체 정보로 저장한걸 string으로 쓸 리가 없으니까 다시 원상복구하는 method가 필요합니다.
